...
{
    // marked as static because we don't need to create an instance of DbInitializer to call this method.
    // Static can be used when not passing any data to the method from an instance of the class.
    public static async Task SeedData(AppDbContext context)
    {
        ...
        // add the activities to the context tracked in memory
